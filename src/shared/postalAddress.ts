...
export const formatAddressLines = (parts: PostalAddressParts): string[] => {
 ...
 */
export const composeAddressSnapshot = (parts: PostalAddressParts): string | null => {
    const lines = formatAddressLines(parts);
