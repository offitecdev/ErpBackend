...
const roleRepositoryForAssignment = new RoleRepository();
 ...
 */
export async function getAssignableTenantIds(
    ...
    for (const rootId of roots) {
        for (const tenantId of collectDescendantIds(active, rootId)) reachable.add(tenantId);
    }
