...
exports.adminModuleKeys = exports.adminPermissionNames = exports.ADMIN_PAGE_LEVELS = exports.pageLevelsFromPermissions = exports.moduleKeysForPageLevels = exports.permissionsForPageLevels = exports.CATALOG_GRANTED_PERMISSION_NAMES = exports.permissionsForPage = exports.sanitizePageLevels = exports.PAGE_LEVEL_FALLBACKS = exports.RETIRED_PAGE_KEYS = exports.clampPageLevel = exports.getPage = exports.ALL_PAGES = exports.PAGE_MODULES = exports.ALWAYS_ON_MODULE_KEYS = void 0;
...
const inheritedLevel = (input, pageKey, maxLevel) => {
    ...
    const relative = exports.PAGE_LEVEL_FALLBACKS[pageKey];
    if (relative) {
        const level = (0, exports.clampPageLevel)(input[relative], maxLevel);
        if (level > best)
            best = level;
    }
    return best;
