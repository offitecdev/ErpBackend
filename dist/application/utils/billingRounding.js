...
exports.openAmount = exports.isFullyBilled = exports.round2 = exports.CENT_ROUNDING_SLACK = exports.FULLY_BILLED_EPSILON = void 0;
/** Percentage points below 100 that still count as "fully billed". */
exports.FULLY_BILLED_EPSILON = 0.005;
/**
 ...
 * goes past a handful).
 */
exports.CENT_ROUNDING_SLACK = 0.05;
 ...
 * small.
 */
const isFullyBilled = (billedPercent, baseAmount, billedAmount) => Number.isFinite(billedPercent)
    && (0, exports.round2)(billedPercent) >= 100 - exports.FULLY_BILLED_EPSILON
    && Math.abs((0, exports.round2)(baseAmount - billedAmount)) <= exports.CENT_ROUNDING_SLACK;
exports.isFullyBilled = isFullyBilled;
/**
 ...
 */
const openAmount = (billedPercent, baseAmount, billedAmount) => (0, exports.isFullyBilled)(billedPercent, baseAmount, billedAmount) ? 0 : (0, exports.round2)(baseAmount - billedAmount);
exports.openAmount = openAmount;
//# sourceMappingURL=billingRounding.js.map