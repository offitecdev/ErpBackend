...
router.get('/work', (0, taskHttp_1.taskRoute)('tasks.reports.work', async (req, res) => {
    res.json(await (0, workReportService_1.getWorkReport)((0, taskMiddleware_1.tasksActor)(res), req.query));
}));
router.get('/team', (0, taskHttp_1.taskRoute)('tasks.reports.team', async (req, res) => {
    res.json(await (0, reportService_1.getTeamReport)((0, taskMiddleware_1.tasksActor)(res), req.query));
}));
router.get('/me', (0, taskHttp_1.taskRoute)('tasks.reports.me', async (req, res) => {
    res.json(await (0, reportService_1.getMyReport)((0, taskMiddleware_1.tasksActor)(res), req.query));
}));
router.get('/person/:employeeId', (0, taskHttp_1.taskRoute)('tasks.reports.person', async (req, res) => {
...
router.get('/task/:taskId', (0, taskHttp_1.taskRoute)('tasks.reports.task', async (req, res) => {
