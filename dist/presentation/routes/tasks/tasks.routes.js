...
const completeBody = zod_1.z.object({ delayReason: noteText.optional() });
...
router.post('/:taskId/partners', (0, taskHttp_1.taskRoute)('tasks.partner.add', async (req, res) => {
    res.json(await (0, taskService_1.addTaskPartner)((0, taskMiddleware_1.tasksActor)(res), (0, taskHttp_1.routeParam)(req, 'taskId'), (0, taskHttp_1.parseInput)(partnerBody, req.body)));
}));
...
router.post('/:taskId/complete', (0, taskHttp_1.taskRoute)('tasks.task.complete', async (req, res) => {
    res.json(await (0, taskService_1.completeTask)((0, taskMiddleware_1.tasksActor)(res), (0, taskHttp_1.routeParam)(req, 'taskId'), (0, taskHttp_1.parseInput)(completeBody, req.body)));
}));
