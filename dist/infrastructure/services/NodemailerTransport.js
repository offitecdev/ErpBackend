...
exports.sendRawMessage = exports.resetTransporters = exports.getTransporter = void 0;
...
const getTransporter = (settings, timeoutMs) => {
...
exports.resetTransporters = resetTransporters;
/**
 ...
 */
const sendRawMessage = async (settings, mime, envelope, timeoutMs) => {
    const transporter = (0, exports.getTransporter)(settings, timeoutMs);
    try {
...
//# sourceMappingURL=NodemailerTransport.js.map