...
exports.queueTaskAssignmentMail = void 0;
...
const loadTask = (taskId) => prisma_client_1.default.crmTask.findUnique({
    where: { id: taskId },
    select: {
        id: true,
        tenantId: true,
...
const sendOne = async (task, recipient, employeeId) => {
    ...
    await (0, MailDispatchService_1.dispatchMail)({ tenantId: task.tenantId, employeeId }, settings, {
        fromEmail,
        fromName,
        to: recipient.email,
        cc: [],
 ...
 */
const queueTaskAssignmentMail = (taskId, employeeId, options = {}) => {
    void (async () => {
    ...
    })().catch((error) => console.error(`[AUFGABE] Mail ${taskId} fehlgeschlagen:`, error?.message || error));
};
exports.queueTaskAssignmentMail = queueTaskAssignmentMail;
//# sourceMappingURL=taskMailService.js.map