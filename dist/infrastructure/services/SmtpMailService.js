...
exports.SmtpMailService = exports.buildMimeMessage = exports.newMessageId = void 0;
...
class SmtpMailService {
    ...
    async send(settings, mail, options = {}) {
        ...
        const budgetMs = (0, mailSocket_1.budgetForMessage)(SEND_BUDGET_MS, Buffer.byteLength(body, "utf8"), SEND_BUDGET_MAX_EXTRA_MS);
        // TESLİM: SMTP konuşmasını nodemailer yürütür (bağlantı havuzu, TLS,
        // kimlik doğrulama); mesajın KENDİSİ yukarıda kurulan MIME'dir.
        await (0, NodemailerTransport_1.sendRawMessage)(settings, body, { from: mail.fromEmail.trim(), to: [mail.to.trim(), ...ccList] }, budgetMs);
